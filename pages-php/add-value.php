...
<!-- HERO BOX -->
<div class="add-value-hero">
  <h1>Add Value</h1>
  <p>Explore our casting capabilities, from traditional methods to advanced manufacturing solutions.</p>
</div>

<!-- GRID BOX: TEXT + IMAGE -->

<section class="add-value-grid">

  <div class="add-value-left">
    <h1>What is add value?</h1>
      <p>
      ...
      and cost-efficiency. At EDS, we offer a wide variety of casting methods
      to meet your technical and economic requirements.
    </p>
  </div>

  <div class="add-value-right">
    <div class="add-value-img-container">
      <img src="/assets/img/add-value/add-value-intro.jpg" alt="add-value Overview Image">
    </div>
...
<!-- SUBTYPES CONTAINERS -->
<div class="add-value-subtypes">

  <section class="metal-printing-3d">
    <div>
 ...
 <section class="printed-cores-3d">
  <div>
  ...
  <section class="suface-finishing">
    <div>
